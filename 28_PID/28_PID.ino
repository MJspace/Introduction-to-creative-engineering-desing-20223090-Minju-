...
#define _EMA_ALPHA 0.5   // EMA weight of new sample (range: 0 to 1) 0.7

// Servo adjustment
#define _DUTY_NEU 1485//1485
#define _DUTY_MIN 796//796
#define _DUTY_MAX 2498//2498
#define _SERVO_ANGLE_DIFF 75 // servo angle difference between _DUTY_MIN and _DUTY_MAX (unit: degree)
#define _SERVO_SPEED 120 // servo speed limit (unit: degree/second)

// PID parameters
#define _DIST_TARGET 155 // center of the rail (unit: mm)
#define _KP 7 // proportional gain
#define _KD 400 // derivative gain
#define _KI 200 // integral gain
...
{
   return 716 + (-2.47 * a_value) + (2.11E-03 * (a_value) * (a_value)); // Replace this with the equation obtained from nonlinear regression analysis
